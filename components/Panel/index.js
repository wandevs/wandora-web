...
class Panel extends Component {
    ...
    this.timer = setInterval(async () => {
      ...
      if (this.state.startTime !== 0 && this.state.timeSpan !== 0 && this.state.stopBefore !== 0) {
        this.setState({
          ...
          buyLeft: this.getLastTime(Date.now() / 1000 - (this.state.startTime + this.state.timeSpan - this.state.stopBefore)),
        })
      } else {
        this.setState({
  ...
  getLastTime(leftTimeSecond) {
    ...
    let h = Math.floor(leftTime / 60 / 60);
    ...
    return (
      <div className={style.panel}>
        ...
        <div className={style.bottomLine}>
          ...
          <div className={style.boxText}>{this.state.endLeft.h}h</div>
          <div className={style.boxText}>{this.state.endLeft.m}m</div>
